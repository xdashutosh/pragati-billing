...
const bm = (cat: string, desc: string, b1: BillingBlockData, b2: BillingBlockData, b3 = Z, b4 = Z): BillingMilestone =>
  ({ category: cat, section: cat, description: desc, uom: 'LS', qty: 1, rate: 0, block1: b1, block2: b2, block3: b3, block4: b4 });
...
const lpwVendor: VendorConfig = {
  id: 'lpw',
  shortName: 'LPW Echur',
  projectName: LPW_PROJECT.name,
  contractor: LPW_PROJECT.contractor,
  client: LPW_PROJECT.client,
  pmc: LPW_PROJECT.pmc,
  woNumber: LPW_PROJECT.woNumber,
  woDate: LPW_PROJECT.woDate,
  currentRA: LPW_PROJECT.currentRA,
  totalBasicCost: LPW_PROJECT.totalBasicCost,
  costPerSqft: LPW_PROJECT.costPerSqft,
  grandTotalArea: LPW_PROJECT.grandTotalArea,
  billingSummaryItems: LPW_PROJECT.billingSummary.items,
  billingSummaryTotals: LPW_PROJECT.billingSummary.totals,
  billingMilestones: LPW_PROJECT.billingMilestones.milestones,
  blockTotals: LPW_PROJECT.milestonesBldg.blockTotals,
  buildingMilestones: LPW_PROJECT.milestonesBldg.milestones,
  infraBillingMilestones: LPW_PROJECT.infraBilling.milestones,
  infraRAMilestones: LPW_PROJECT.infraRA.milestones,
  infraRATotal: LPW_PROJECT.infraRA.totalInfraScope,
  infraMilestones: LPW_PROJECT.milestoneInfra.milestones,
  infraMilestoneTotal: LPW_PROJECT.milestoneInfra.totalInfraAmount,
  // New PO Abstract fields
  abstractSummary: LPW_PROJECT.abstractSummary,
  buildingBlocks: LPW_PROJECT.buildingCostSheet.blocks,
  infraSections: LPW_PROJECT.infraCostSheet.sections,
  defaultMaterialRows: LPW_PROJECT.defaultMaterialRows,
  defaultHoldItems: LPW_PROJECT.defaultHoldItems,
};
...
const kgVendor: VendorConfig = {
  ...
  // New PO Abstract fields
  abstractSummary: { projectName: 'KG Hosur', totalBasicCost: kgSummaryTotals.orderAmount, costPerSqft: Math.round(kgSummaryTotals.orderAmount / 53_000), items: [] },
  buildingBlocks: [],
  infraSections: [],
  defaultMaterialRows: [
...
const mllVendor: VendorConfig = {
  ...
  // New PO Abstract fields
  abstractSummary: { projectName: 'MLL Pune', totalBasicCost: mllSummaryTotals.orderAmount, costPerSqft: Math.round(mllSummaryTotals.orderAmount / 95_000), items: [] },
  buildingBlocks: [],
  infraSections: [],
  defaultMaterialRows: [
...
const tvsVendor: VendorConfig = {
  ...
  // New PO Abstract fields
  abstractSummary: { projectName: 'TVS Chennai', totalBasicCost: tvsSummaryTotals.orderAmount, costPerSqft: Math.round(tvsSummaryTotals.orderAmount / 38_000), items: [] },
  buildingBlocks: [],
  infraSections: [],
  defaultMaterialRows: [
